...
export const _enrollInPlacementCycle = async (enrollment: Placement_Cycle_Enrolment): Promise<Placement_Cycle_Enrolment | undefined> => {
    return await Placement_Cycle_Enrollment_Repository.save(enrollment);
}

export const _enrolledPlacementCycles = async (admno: string) => {
